...
onBootstrap((e) => {
    ...
    try {
        ...
        settings.meta.appURL = "https://caree2day.com";
...
<p><a href="https://caree2day.com/reset-password?token={TOKEN}" style="background:#6366f1;color:#fff;padding:12px 24px;border-radius:6px;text-decoration:none;display:inline-block;font-weight:600;">Reset Password</a></p>
<p>Or copy this link: https://caree2day.com/reset-password?token={TOKEN}</p>
...
<p><a href="https://caree2day.com/verify-email?token={TOKEN}" style="background:#6366f1;color:#fff;padding:12px 24px;border-radius:6px;text-decoration:none;display:inline-block;font-weight:600;">Verify Email</a></p>
<p>Or copy this link: https://caree2day.com/verify-email?token={TOKEN}</p>
