...
migrate((app) => {
  ...
  r0.set("phase", 1);
  r0.set("phaseTitle", "Excel & Statistics");
  ...
  r2.set("phase", 3);
  r2.set("phaseTitle", "Python for Analysis");
  ...
  r3.set("phase", 4);
  r3.set("phaseTitle", "Business Intelligence Tools");
  ...
  r4.set("phase", 5);
  r4.set("phaseTitle", "Business Acumen & Storytelling");
  ...
  r5.set("phase", 1);
  r5.set("phaseTitle", "IT & Networking Basics");
  ...
  r6.set("phase", 2);
  r6.set("phaseTitle", "Security Fundamentals");
  ...
  r7.set("phase", 3);
  r7.set("phaseTitle", "SOC Operations & SIEM");
  ...
  r8.set("phase", 4);
  r8.set("phaseTitle", "Incident Response");
  ...
  r9.set("phase", 5);
  r9.set("phaseTitle", "Threat Intelligence & Hunting");
  ...
  r10.set("phase", 1);
  r10.set("phaseTitle", "Salesforce Fundamentals");
  ...
  r11.set("phase", 2);
  r11.set("phaseTitle", "Apex Development");
  ...
  r12.set("phase", 3);
  r12.set("phaseTitle", "Lightning Web Components (LWC)");
  ...
  r13.set("phase", 4);
  r13.set("phaseTitle", "Integrations & APIs");
  ...
  r14.set("phase", 5);
  r14.set("phaseTitle", "DevOps & Testing");
  ...
  r15.set("phase", 1);
  r15.set("phaseTitle", "Math & Python");
  ...
  r16.set("phase", 2);
  r16.set("phaseTitle", "Image Processing");
  ...
  r17.set("phase", 3);
  r17.set("phaseTitle", "Deep Learning for Vision");
  ...
  r18.set("phase", 4);
  r18.set("phaseTitle", "Advanced Topics");
  ...
  r20.set("phase", 1);
  r20.set("phaseTitle", "Python & ML Fundamentals");
  ...
  r21.set("phase", 2);
  r21.set("phaseTitle", "Classical NLP");
  ...
  r22.set("phase", 3);
  r22.set("phaseTitle", "Transformers & BERT/GPT");
  ...
  r23.set("phase", 4);
  r23.set("phaseTitle", "Advanced NLP");
  ...
  r24.set("phase", 5);
  r24.set("phaseTitle", "Production NLP");
  ...
  r25.set("phase", 1);
  r25.set("phaseTitle", "Networking & Linux");
  ...
  r26.set("phase", 2);
  r26.set("phaseTitle", "Security Fundamentals");
  ...
  r27.set("phase", 3);
  r27.set("phaseTitle", "Penetration Testing Tools");
  ...
  r28.set("phase", 4);
  r28.set("phaseTitle", "Web & Network Exploitation");
  ...
  r29.set("phase", 5);
  r29.set("phaseTitle", "Reporting & Methodology");
  ...
  r30.set("phase", 1);
  r30.set("phaseTitle", "Engineering Foundation");
  ...
  r31.set("phase", 2);
  r31.set("phaseTitle", "Project Management");
  ...
  r32.set("phase", 3);
  r32.set("phaseTitle", "Program Management Skills");
  ...
  r33.set("phase", 4);
  r33.set("phaseTitle", "Stakeholder & Communication");
  ...
  r34.set("phase", 5);
  r34.set("phaseTitle", "TPM Specialization");
  ...
  r35.set("phase", 1);
  r35.set("phaseTitle", "GIS Fundamentals");
  ...
  r36.set("phase", 2);
  r36.set("phaseTitle", "Python for GIS");
  ...
  r37.set("phase", 3);
  r37.set("phaseTitle", "Spatial Databases");
  ...
  r38.set("phase", 4);
  r38.set("phaseTitle", "Web GIS & Visualization");
  ...
  r39.set("phase", 5);
  r39.set("phaseTitle", "Remote Sensing & ML");
