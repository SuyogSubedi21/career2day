...
migrate((app) => {
  ...
  r0.set("phase", 1);
  r0.set("title", "Software Engineering Foundation");
  ...
  r1.set("phase", 2);
  r1.set("title", "Cloud & Infrastructure");
  ...
  r2.set("phase", 3);
  r2.set("title", "Architecture Patterns");
  ...
  r3.set("phase", 4);
  r3.set("title", "Business & Communication");
  ...
  r4.set("phase", 5);
  r4.set("title", "Certifications & Portfolio");
  ...
  r7.set("phase", 3);
  r7.set("title", "Advanced Database Concepts");
  ...
  r8.set("phase", 4);
  r8.set("title", "NoSQL & Cloud Databases");
  ...
  r9.set("phase", 5);
  r9.set("title", "Backup, HA & Security");
  ...
  r10.set("phase", 1);
  r10.set("title", "Programming Foundation");
  ...
  r11.set("phase", 2);
  r11.set("title", "Game Engine (Unity or Unreal)");
  ...
  r12.set("phase", 3);
  r12.set("title", "Game Design & Math");
  ...
  r14.set("phase", 5);
  r14.set("title", "Networking & Publishing");
  ...
  r15.set("phase", 1);
  r15.set("title", "Biology & Chemistry Basics");
  ...
  r16.set("phase", 2);
  r16.set("title", "Python & R Programming");
  ...
  r17.set("phase", 3);
  r17.set("title", "Genomics & Sequence Analysis");
  ...
  r18.set("phase", 4);
  r18.set("title", "Machine Learning for Biology");
  ...
  r20.set("phase", 1);
  r20.set("title", "LLM Fundamentals");
  ...
  r21.set("phase", 2);
  r21.set("title", "Prompt Engineering Techniques");
  ...
  r22.set("phase", 3);
  r22.set("title", "RAG & Agentic Systems");
  ...
  r23.set("phase", 4);
  r23.set("title", "Evaluation & Testing");
  ...
  r24.set("phase", 5);
  r24.set("title", "Product & Deployment");
  ...
  r25.set("phase", 1);
  r25.set("title", "Electronics Fundamentals");
  ...
  r26.set("phase", 2);
  r26.set("title", "Digital Design & HDL");
  ...
  r27.set("phase", 3);
  r27.set("title", "Computer Architecture");
  ...
  r29.set("phase", 5);
  r29.set("title", "Chip Design (VLSI)");
  ...
  r30.set("phase", 1);
  r30.set("title", "Math & Programming");
  ...
  r31.set("phase", 2);
  r31.set("title", "Computer Vision & Sensors");
  ...
  r32.set("phase", 3);
  r32.set("title", "State Estimation & Localization");
  ...
  r33.set("phase", 4);
  r33.set("title", "Path Planning & Control");
  ...
  r34.set("phase", 5);
  r34.set("title", "End-to-End Deep Learning & Safety");
  ...
  r35.set("phase", 1);
  r35.set("title", "Design Fundamentals");
  ...
  r38.set("phase", 4);
  r38.set("title", "Interaction & Motion");
  ...
  r39.set("phase", 5);
  r39.set("title", "Technical Implementation");
  ...
  r40.set("phase", 1);
  r40.set("title", "Writing Fundamentals");
  ...
  r42.set("phase", 3);
  r42.set("title", "API Documentation");
  ...
  r43.set("phase", 4);
  r43.set("title", "Technical Domain Knowledge");
