...
migrate((app) => {
  ...
  r0.set("explanation", "Answer: Machine Learning");
  ...
  r1.set("explanation", "Answer: Scikit-learn");
  ...
  r2.set("explanation", "Answer: Learning with labeled data");
  ...
  r3.set("explanation", "Answer: Logistic Regression");
  ...
  r4.set("explanation", "Answer: Model performs well on training but poorly on test");
  ...
  r5.set("explanation", "Answer: Step size during optimization");
  ...
  r6.set("explanation", "Answer: F1-Score");
  ...
  r7.set("explanation", "Answer: Prevent overfitting");
  ...
  r8.set("explanation", "Answer: Principal Component Analysis");
  ...
  r9.set("explanation", "Answer: ReLU");
  ...
  r10.set("explanation", "Answer: Penalizes leaf weights to prevent overfitting");
  ...
  r11.set("explanation", "Answer: O(n²) to O(n³)");
  ...
  r12.set("explanation", "Answer: Query, Key, Value");
  ...
  r13.set("explanation", "Answer: Distance between two probability distributions");
  ...
  r14.set("explanation", "Answer: Batch Normalization");
  ...
  r15.set("explanation", "Answer: Large Language Model");
  ...
  r16.set("explanation", "Answer: OpenAI");
  ...
  r18.set("explanation", "Answer: Input text given to the model");
  ...
  r19.set("explanation", "Answer: Llama 3");
  ...
  r20.set("explanation", "Answer: Low-Rank Adaptation");
  ...
  r21.set("explanation", "Answer: Controls randomness of outputs");
  ...
  r22.set("explanation", "Answer: Storing embeddings for semantic search");
  ...
  r23.set("explanation", "Answer: Model generating false information confidently");
  ...
  r24.set("explanation", "Answer: Asking model to show reasoning steps");
  ...
  r25.set("explanation", "Answer: Memory management technique for KV cache using paging");
  ...
  r26.set("explanation", "Answer: Human preferences between outputs");
  ...
  r27.set("explanation", "Answer: Using a small draft model to propose tokens verified by a large model");
  ...
  r28.set("explanation", "Answer: Fewer active parameters per token, reducing compute");
  ...
  r29.set("explanation", "Answer: Eliminates need for separate reward model using preference data directly");
  ...
  r30.set("explanation", "Answer: Elastic Compute Cloud");
  ...
  r32.set("explanation", "Answer: Identity and access management");
  ...
  r33.set("explanation", "Answer: Virtual Private Cloud");
  ...
  r34.set("explanation", "Answer: Lambda");
  ...
  r35.set("explanation", "Answer: Security groups are stateful, NACLs are stateless");
  ...
  r36.set("explanation", "Answer: Recovery Time Objective");
  ...
  r37.set("explanation", "Answer: Allow private subnet instances to access internet");
  ...
  r38.set("explanation", "Answer: Track the current state of infrastructure");
  ...
  r39.set("explanation", "Answer: Smallest deployable unit containing one or more containers");
  ...
  r40.set("explanation", "Answer: A distributed system can only guarantee 2 of: Consistency, Availability, Partition Tolerance");
  ...
  r41.set("explanation", "Answer: Blue-green switches all traffic at once; canary gradually routes a % to new version");
  ...
  r42.set("explanation", "Answer: Traffic cannot transit through a peered VPC to reach another VPC");
  ...
  r43.set("explanation", "Answer: Managing distributed transactions across services");
  ...
  r44.set("explanation", "Answer: Horizontal adds more instances; vertical increases instance resources");
  ...
  r45.set("explanation", "Answer: Continuous Integration/Continuous Deployment");
  ...
  r46.set("explanation", "Answer: Containerizing applications");
  ...
  r47.set("explanation", "Answer: Infrastructure as Code");
  ...
  r48.set("explanation", "Answer: Using Git as source of truth for infrastructure");
  ...
  r49.set("explanation", "Answer: Container orchestration");
  ...
  r50.set("explanation", "Answer: StatefulSet maintains pod identity and stable storage; Deployment does not");
  ...
  r51.set("explanation", "Answer: Service Level Objective - a target metric for reliability");
  ...
  r52.set("explanation", "Answer: Running the same operation multiple times produces the same result");
  ...
  r53.set("explanation", "Answer: Metrics collection and monitoring");
  ...
  r54.set("explanation", "Answer: A package of Kubernetes resources");
  ...
  r55.set("explanation", "Answer: Extended Berkeley Packet Filter - allows safe kernel-level observability and networking");
  ...
  r56.set("explanation", "Answer: The allowed amount of unreliability derived from SLO; when exhausted, features freeze");
  ...
  r57.set("explanation", "Answer: Intentionally injecting failures to test system resilience");
  ...
  r58.set("explanation", "Answer: Mutual TLS - both client and server authenticate each other");
  ...
  r59.set("explanation", "Answer: Policy-as-code engine for authorization and compliance");
  ...
  r60.set("explanation", "Answer: Confidentiality, Integrity, Availability");
  ...
  r61.set("explanation", "Answer: Social engineering via deceptive emails");
  ...
  r62.set("explanation", "Answer: Network security device that monitors and filters traffic");
  ...
  r63.set("explanation", "Answer: Multi-Factor Authentication");
  ...
  r64.set("explanation", "Answer: Inserting malicious SQL code into a query");
  ...
  r65.set("explanation", "Answer: IDS detects threats; IPS detects and blocks them");
  ...
  r66.set("explanation", "Answer: A knowledge base of adversary tactics and techniques");
  ...
  r67.set("explanation", "Answer: Unknown vulnerability with no patch available");
  ...
  r68.set("explanation", "Answer: Cross-Site Scripting - injecting malicious scripts into web pages");
  ...
  r69.set("explanation", "Answer: Monitor and respond to security incidents");
  ...
  r70.set("explanation", "Answer: Server-Side Request Forgery - tricking server into making requests to internal resources");
  ...
  r71.set("explanation", "Answer: Delivery");
  ...
  r72.set("explanation", "Answer: Moving through a network after initial compromise to reach target");
  ...
  r73.set("explanation", "Answer: Symmetric uses one key; asymmetric uses public/private key pair");
  ...
  r74.set("explanation", "Answer: Forging a Kerberos TGT using stolen KRBTGT hash for persistent access");
  ...
  r75.set("explanation", "Answer: Extract, Transform, Load");
  ...
  r76.set("explanation", "Answer: Real-time data streaming");
  ...
  r77.set("explanation", "Answer: Centralized repository for structured analytical data");
  ...
  r78.set("explanation", "Answer: Data Build Tool for transforming data in warehouses");
  ...
  r79.set("explanation", "Answer: Large-scale data processing");
  ...
  r80.set("explanation", "Answer: Data lake stores raw data in native format; warehouse stores structured processed data");
  ...
  r81.set("explanation", "Answer: Tracks historical changes by adding new rows with versioning");
  ...
  r82.set("explanation", "Answer: Improving query performance by dividing data into segments");
  ...
  r83.set("explanation", "Answer: Central fact table surrounded by dimension tables");
  ...
  r84.set("explanation", "Answer: Tracking and capturing changes made to a database");
  ...
  r85.set("explanation", "Answer: Lambda has both batch and stream layers; Kappa uses only stream processing");
  ...
  r86.set("explanation", "Answer: Multi-dimensional clustering to colocate related data in files for faster queries");
  ...
  r87.set("explanation", "Answer: At-least-once may duplicate; exactly-once guarantees single delivery");
  ...
  r88.set("explanation", "Answer: Uneven data distribution across partitions causing hotspots; fixed by salting or repartitioning");
  ...
  r89.set("explanation", "Answer: Agreement on data schema, quality, and SLAs between producers and consumers");
  ...
  r90.set("explanation", "Answer: HyperText Markup Language");
  ...
  r91.set("explanation", "Answer: A JavaScript library for building UIs");
  ...
  r92.set("explanation", "Answer: Application Programming Interface");
  ...
  r93.set("explanation", "Answer: JavaScript runtime built on Chrome's V8 engine");
  ...
  r94.set("explanation", "Answer: Cascading Style Sheets");
  ...
  r95.set("explanation", "Answer: In-memory representation of the real DOM for efficient updates");
  ...
  r96.set("explanation", "Answer: Cross-Origin Resource Sharing - controls cross-domain requests");
  ...
  r97.set("explanation", "Answer: Server-Side Rendering - HTML generated on server per request");
  ...
  r98.set("explanation", "Answer: Fetching N related records requires N additional queries");
  ...
  r99.set("explanation", "Answer: JSON Web Token for stateless authentication");
  ...
  r100.set("explanation", "Answer: useCallback memoizes functions; useMemo memoizes computed values");
  ...
  r101.set("explanation", "Answer: Regenerates static pages in background after a revalidate interval");
  ...
  r102.set("explanation", "Answer: Cursor uses a pointer to the last item; offset uses skip/limit. Cursor is more efficient for large datasets.");
  ...
  r103.set("explanation", "Answer: Eliminating dead/unused code from the final bundle");
  ...
  r104.set("explanation", "Answer: Optimistic updates UI immediately before server confirms; pessimistic waits for confirmation");
