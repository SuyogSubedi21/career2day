...
migrate((app) => {
  ...
  record5.set("careerSlug", "infrastructure-engineer");
  record5.set("phase", 1);
  ...
  record6.set("careerSlug", "infrastructure-engineer");
  record6.set("phase", 2);
  ...
  record7.set("careerSlug", "infrastructure-engineer");
  record7.set("phase", 3);
  ...
  record8.set("careerSlug", "infrastructure-engineer");
  record8.set("phase", 4);
  ...
  record9.set("careerSlug", "infrastructure-engineer");
  record9.set("phase", 5);
  ...
  record10.set("careerSlug", "devops-architect");
  ...
  record11.set("careerSlug", "devops-architect");
  ...
  record12.set("careerSlug", "devops-architect");
  ...
  record13.set("careerSlug", "devops-architect");
  ...
  record14.set("careerSlug", "devops-architect");
  ...
  console.log("Seeded 20 careerRoadmaps (new batch 1).");
}, (app) => {});