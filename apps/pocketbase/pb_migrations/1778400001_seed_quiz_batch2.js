...
migrate((app) => {
  ...
  r0.set("explanation", "Answer: A distributed, immutable ledger of transactions");
  ...
  r1.set("explanation", "Answer: Self-executing code on a blockchain");
  ...
  r2.set("explanation", "Answer: Non-Fungible Token - unique digital asset");
  ...
  r3.set("explanation", "Answer: Solidity");
  ...
  r4.set("explanation", "Answer: Fee paid for computation on the network");
  ...
  r5.set("explanation", "Answer: Attacker repeatedly calls a function before the first call finishes to drain funds");
  ...
  r6.set("explanation", "Answer: Automated Market Maker - uses liquidity pools instead of order books");
  ...
  r7.set("explanation", "Answer: A scaling solution built on top of a base blockchain");
  ...
  r8.set("explanation", "Answer: Loss from providing liquidity when asset prices change relative to each other");
  ...
  r9.set("explanation", "Answer: ERC-20 is fungible tokens; ERC-721 is non-fungible tokens (NFTs)");
  ...
  r10.set("explanation", "Answer: Profit extractable by reordering, inserting, or censoring transactions in a block");
  ...
  r11.set("explanation", "Answer: Optimistic assumes valid and uses fraud proofs; ZK uses validity proofs cryptographically");
  ...
  r12.set("explanation", "Answer: Deploy contracts to deterministic addresses before deployment");
  ...
  r13.set("explanation", "Answer: Allows smart contract wallets as first-class accounts without changing the protocol");
  ...
  r14.set("explanation", "Answer: Uncollateralized loan repaid in same transaction; risk is enabling attack vectors for manipulation");
  ...
  r15.set("explanation", "Answer: Site Reliability Engineering");
  ...
  r16.set("explanation", "Answer: Service Level Objective");
  ...
  r17.set("explanation", "Answer: Manual, repetitive operational work that can be automated");
  ...
  r18.set("explanation", "Answer: Mean Time To Recovery");
  ...
  r19.set("explanation", "Answer: A blameless review of an incident to learn and prevent recurrence");
  ...
  r20.set("explanation", "Answer: Latency, Traffic, Errors, Saturation");
  ...
  r21.set("explanation", "Answer: The allowed amount of unreliability based on SLO");
  ...
  r22.set("explanation", "Answer: Stops calls to a failing service to allow recovery");
  ...
  r23.set("explanation", "Answer: High latency at the 95th or 99th percentile affecting a small % of requests");
  ...
  r24.set("explanation", "Answer: Intentionally injecting failures to test system resilience");
  ...
  r25.set("explanation", "Answer: L = λW: average items in system equals arrival rate × average time in system");
  ...
  r26.set("explanation", "Answer: Active-active serves traffic from all regions; active-passive has a standby region");
  ...
  r27.set("explanation", "Answer: Sending duplicate requests to multiple backends and using the first response");
  ...
  r28.set("explanation", "Answer: Network partition causing two parts of cluster to act as separate independent systems");
  ...
  r29.set("explanation", "Answer: Kubernetes Event-Driven Autoscaling - scales based on event sources like Kafka");
  ...
  r30.set("explanation", "Answer: Integrated circuit with processor, memory, and peripherals");
  ...
  r31.set("explanation", "Answer: Real-Time Operating System");
  ...
  r32.set("explanation", "Answer: General Purpose Input/Output pins");
  ...
  r33.set("explanation", "Answer: Universal Asynchronous Receiver-Transmitter");
  ...
  r34.set("explanation", "Answer: Signal that pauses the CPU to handle an event");
  ...
  r35.set("explanation", "Answer: High-priority task blocked by low-priority task holding a resource");
  ...
  r36.set("explanation", "Answer: Prevents compiler from optimizing away reads/writes to hardware registers");
  ...
  r37.set("explanation", "Answer: Direct Memory Access - transfers data without CPU involvement");
  ...
  r38.set("explanation", "Answer: Mutex is for mutual exclusion (ownership); semaphore is for signaling/counting");
  ...
  r39.set("explanation", "Answer: Byte order for storing multi-byte data in memory");
  ...
  r40.set("explanation", "Answer: Defines memory layout, section placement, and addresses for the compiled binary");
  ...
  r41.set("explanation", "Answer: Table at start of flash containing reset handler and interrupt handlers");
  ...
  r42.set("explanation", "Answer: Hard: missing deadline is catastrophic failure; soft: missing deadline degrades performance");
  ...
  r43.set("explanation", "Answer: Data must be stored at addresses matching its size; misalignment causes faults or performance loss");
  ...
  r44.set("explanation", "Answer: Coding standard for safety-critical embedded C to reduce undefined behavior");
  ...
  r45.set("explanation", "Answer: Exploratory Data Analysis");
  ...
  r46.set("explanation", "Answer: Probability of observing results if null hypothesis is true");
  ...
  r47.set("explanation", "Answer: Measure of relationship strength between variables");
  ...
  r48.set("explanation", "Answer: Pandas");
  ...
  r49.set("explanation", "Answer: Visualizing distribution and outliers");
  ...
  r50.set("explanation", "Answer: Sample means approximate normal distribution as sample size increases");
  ...
  r51.set("explanation", "Answer: False positive - rejecting a true null hypothesis");
  ...
  r52.set("explanation", "Answer: High correlation between predictor variables in regression");
  ...
  r53.set("explanation", "Answer: SHapley Additive exPlanations");
  ...
  r54.set("explanation", "Answer: Statistical properties (mean, variance) do not change over time");
  ...
  r55.set("explanation", "Answer: Pearson measures linear relationship; Spearman measures monotonic relationship on ranks");
  ...
  r56.set("explanation", "Answer: Bagging trains models in parallel on random subsets; boosting trains sequentially correcting errors");
  ...
  r57.set("explanation", "Answer: Penalizes large coefficients to prevent overfitting");
  ...
  r58.set("explanation", "Answer: Finding parameters that maximize probability of observed data");
  ...
  r59.set("explanation", "Answer: t-SNE is non-linear for visualization; PCA is linear for dimensionality reduction");
  ...
  r60.set("explanation", "Answer: Application Programming Interface");
  ...
  r61.set("explanation", "Answer: POST");
  ...
  r62.set("explanation", "Answer: Data structure that speeds up queries");
  ...
  r63.set("explanation", "Answer: In-memory caching and data store");
  ...
  r64.set("explanation", "Answer: JSON Web Token");
  ...
  r65.set("explanation", "Answer: 1 query for list + N queries for each item's relations");
  ...
  r66.set("explanation", "Answer: Optimistic checks for conflicts at commit; pessimistic locks rows immediately");
  ...
  r67.set("explanation", "Answer: Making same request multiple times produces same result");
  ...
  r68.set("explanation", "Answer: Decoupling services and async processing");
  ...
  r69.set("explanation", "Answer: High-performance RPC framework using Protocol Buffers");
  ...
  r70.set("explanation", "Answer: Manages distributed transactions using a sequence of local transactions with compensating actions");
  ...
  r71.set("explanation", "Answer: Storing state changes as a sequence of events rather than current state");
  ...
  r72.set("explanation", "Answer: Command Query Responsibility Segregation - separates read and write models");
  ...
  r73.set("explanation", "Answer: Horizontally partitioning data across multiple databases");
  ...
  r74.set("explanation", "Answer: Stops requests to a failing service; opens after threshold; tests with half-open state");
  ...
  r75.set("explanation", "Answer: Swift");
  ...
  r76.set("explanation", "Answer: Cross-platform mobile framework by Google");
  ...
  r77.set("explanation", "Answer: Native uses platform-specific code; cross-platform uses shared codebase");
  ...
  r78.set("explanation", "Answer: Framework for building mobile apps using React and JavaScript");
  ...
  r79.set("explanation", "Answer: Android app development");
  ...
  r80.set("explanation", "Answer: Model-View-ViewModel - separates UI from business logic");
  ...
  r81.set("explanation", "Answer: Automatic Reference Counting - manages memory automatically");
  ...
  r82.set("explanation", "Answer: Two objects holding strong references to each other causing memory leak");
  ...
  r83.set("explanation", "Answer: Lightweight threads for async programming");
  ...
  r84.set("explanation", "Answer: Providing dependencies from outside rather than creating them inside");
  ...
  r85.set("explanation", "Answer: Combine is reactive streams framework; async/await is structured concurrency for sequential async code");
  ...
  r86.set("explanation", "Answer: State management pattern using unidirectional data flow with reducers and effects");
  ...
  r87.set("explanation", "Answer: Hardcoding expected server certificate to prevent MITM attacks");
  ...
  r88.set("explanation", "Answer: App works fully offline and syncs when connected");
  ...
  r89.set("explanation", "Answer: Application Not Responding - triggered when UI thread blocked over 5 seconds");
  ...
  r90.set("explanation", "Answer: Product Requirements Document");
  ...
  r91.set("explanation", "Answer: Minimum Viable Product");
  ...
  r92.set("explanation", "Answer: Net Promoter Score");
  ...
  r93.set("explanation", "Answer: Objectives and Key Results");
  ...
  r94.set("explanation", "Answer: As a [user], I want [feature] so that [benefit]");
  ...
  r95.set("explanation", "Answer: Reach × Impact × Confidence ÷ Effort");
  ...
  r96.set("explanation", "Answer: When a product satisfies a strong market demand");
  ...
  r97.set("explanation", "Answer: Measuring user engagement and stickiness");
  ...
  r98.set("explanation", "Answer: Framework focusing on what customers hire a product to accomplish");
  ...
  r99.set("explanation", "Answer: Single metric that best captures core product value delivered to customers");
  ...
  r100.set("explanation", "Answer: PLG uses product itself to acquire/retain users; SLG relies on sales team to close deals");
  ...
  r101.set("explanation", "Answer: Output: features shipped; outcome: business/user impact achieved");
  ...
  r102.set("explanation", "Answer: Product becomes more valuable as more people use it");
  ...
  r103.set("explanation", "Answer: Diverge-converge twice: discover→define→develop→deliver");
  ...
  r104.set("explanation", "Answer: Data-driven lets data make decisions; data-informed uses data as one input alongside judgment");
