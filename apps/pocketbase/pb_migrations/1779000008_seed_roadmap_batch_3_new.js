...
migrate((app) => {
  ...
  record0.set("careerSlug", "performance-engineer");
  record0.set("phase", 1);
  ...
  record1.set("careerSlug", "performance-engineer");
  record1.set("phase", 2);
  ...
  record2.set("careerSlug", "performance-engineer");
  record2.set("phase", 3);
  ...
  record3.set("careerSlug", "performance-engineer");
  record3.set("phase", 4);
  ...
  record4.set("careerSlug", "performance-engineer");
  record4.set("phase", 5);
  ...
  record10.set("careerSlug", "siem-analyst");
  ...
  record11.set("careerSlug", "siem-analyst");
  ...
  record12.set("careerSlug", "siem-analyst");
  ...
  record13.set("careerSlug", "siem-analyst");
  ...
  record14.set("careerSlug", "siem-analyst");
  ...
  record15.set("careerSlug", "systems-administrator");
  ...
  record16.set("careerSlug", "systems-administrator");
  ...
  record17.set("careerSlug", "systems-administrator");
  ...
  record18.set("careerSlug", "systems-administrator");
  ...
  record19.set("careerSlug", "systems-administrator");
  ...
  console.log("Seeded 20 careerRoadmaps (new batch 3).");
}, (app) => {});