...
migrate((app) => {
  ...
  r0.set("phase", 1);
  r0.set("title", "Mathematics & Statistics Foundation");
  ...
  r1.set("phase", 2);
  r1.set("title", "Python Programming");
  ...
  r2.set("phase", 3);
  r2.set("title", "Machine Learning Fundamentals");
  ...
  r6.set("phase", 2);
  r6.set("title", "Deep Learning & NLP");
  ...
  r8.set("phase", 4);
  r8.set("title", "Fine-tuning & Alignment");
  ...
  r9.set("phase", 5);
  r9.set("title", "Deployment & Serving");
  ...
  r10.set("phase", 1);
  r10.set("title", "Linux & Networking Basics");
  ...
  r11.set("phase", 2);
  r11.set("title", "Cloud Fundamentals (AWS/Azure/GCP)");
  ...
  r12.set("phase", 3);
  r12.set("title", "Infrastructure as Code");
  ...
  r13.set("phase", 4);
  r13.set("title", "Containers & Orchestration");
  ...
  r14.set("phase", 5);
  r14.set("title", "Security & Cost Optimization");
  ...
  r15.set("phase", 1);
  r15.set("title", "Linux & Shell Scripting");
  ...
  r16.set("phase", 2);
  r16.set("title", "Version Control & CI/CD");
  ...
  r17.set("phase", 3);
  r17.set("title", "Containers & Kubernetes");
  ...
  r19.set("phase", 5);
  r19.set("title", "Monitoring & Observability");
  ...
  r20.set("phase", 1);
  r20.set("title", "Networking & OS Fundamentals");
  ...
  r21.set("phase", 2);
  r21.set("title", "Security Fundamentals");
  ...
  r22.set("phase", 3);
  r22.set("title", "Ethical Hacking & Pen Testing");
  ...
  r23.set("phase", 4);
  r23.set("title", "Blue Team / Defense");
  ...
  r24.set("phase", 5);
  r24.set("title", "Cloud Security & Compliance");
  ...
  r25.set("phase", 1);
  r25.set("title", "Programming Fundamentals");
  ...
  r26.set("phase", 2);
  r26.set("title", "Databases & Storage");
  ...
  r27.set("phase", 3);
  r27.set("title", "Data Pipeline Tools");
  ...
  r28.set("phase", 4);
  r28.set("title", "Cloud Data Platforms");
  ...
  r29.set("phase", 5);
  r29.set("title", "Data Quality & Governance");
  ...
  r30.set("phase", 1);
  r30.set("title", "HTML, CSS, JavaScript");
  ...
  r31.set("phase", 2);
  r31.set("title", "React & Frontend Framework");
  ...
  r32.set("phase", 3);
  r32.set("title", "Backend Development");
  ...
  r34.set("phase", 5);
  r34.set("title", "DevOps & Deployment");
  ...
  r35.set("phase", 1);
  r35.set("title", "Web Development Basics");
  ...
  r36.set("phase", 2);
  r36.set("title", "Blockchain Fundamentals");
  ...
  r37.set("phase", 3);
  r37.set("title", "Smart Contract Development");
  ...
  r39.set("phase", 5);
  r39.set("title", "DeFi & Advanced Concepts");
  ...
  r40.set("phase", 1);
  r40.set("title", "Software Engineering Basics");
  ...
  r41.set("phase", 2);
  r41.set("title", "Networking & Systems");
  ...
  r42.set("phase", 3);
  r42.set("title", "Observability & Monitoring");
  ...
  r43.set("phase", 4);
  r43.set("title", "Kubernetes & Cloud");
