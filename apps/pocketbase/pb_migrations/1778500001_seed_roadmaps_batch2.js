...
migrate((app) => {
  ...
  r0.set("phase", 1);
  r0.set("phaseTitle", "C/C++ Programming");
  ...
  r1.set("phase", 2);
  r1.set("phaseTitle", "Computer Architecture");
  ...
  r2.set("phase", 3);
  r2.set("phaseTitle", "Microcontrollers & RTOS");
  ...
  r3.set("phase", 4);
  r3.set("phaseTitle", "Communication Protocols");
  ...
  r4.set("phase", 5);
  r4.set("phaseTitle", "IoT & Edge Computing");
  ...
  r5.set("phase", 1);
  r5.set("phaseTitle", "Statistics & Mathematics");
  ...
  r6.set("phase", 2);
  r6.set("phaseTitle", "Python & Data Tools");
  ...
  r7.set("phase", 3);
  r7.set("phaseTitle", "Machine Learning");
  ...
  r8.set("phase", 4);
  r8.set("phaseTitle", "SQL & Databases");
  ...
  r9.set("phase", 5);
  r9.set("phaseTitle", "Communication & Domain Knowledge");
  ...
  r10.set("phase", 1);
  r10.set("phaseTitle", "Programming Language");
  ...
  r11.set("phase", 2);
  r11.set("phaseTitle", "APIs & Web Frameworks");
  ...
  r13.set("phase", 4);
  r13.set("phaseTitle", "System Design & Architecture");
  ...
  r14.set("phase", 5);
  r14.set("phaseTitle", "DevOps & Deployment");
  ...
  r15.set("phase", 1);
  r15.set("phaseTitle", "Choose Platform & Language");
  ...
  r16.set("phase", 2);
  r16.set("phaseTitle", "UI Development");
  ...
  r17.set("phase", 3);
  r17.set("phaseTitle", "Networking & State Management");
  ...
  r18.set("phase", 4);
  r18.set("phaseTitle", "Advanced Features");
  ...
  r19.set("phase", 5);
  r19.set("phaseTitle", "App Store & CI/CD");
  ...
  r20.set("phase", 1);
  r20.set("phaseTitle", "Product Fundamentals");
  ...
  r21.set("phase", 2);
  r21.set("phaseTitle", "Analytics & Data");
  ...
  r22.set("phase", 3);
  r22.set("phaseTitle", "Technical Skills");
  ...
  r23.set("phase", 4);
  r23.set("phaseTitle", "Strategy & Execution");
  ...
  r24.set("phase", 5);
  r24.set("phaseTitle", "Leadership & Communication");
  ...
  r25.set("phase", 1);
  r25.set("phaseTitle", "Mathematics Foundation");
  ...
  r26.set("phase", 2);
  r26.set("phaseTitle", "Quantum Mechanics Basics");
  ...
  r27.set("phase", 3);
  r27.set("phaseTitle", "Quantum Computing Theory");
  ...
  r28.set("phase", 4);
  r28.set("phaseTitle", "Quantum Programming");
  ...
  r29.set("phase", 5);
  r29.set("phaseTitle", "Quantum Applications");
  ...
  r30.set("phase", 1);
  r30.set("phaseTitle", "Programming Foundation");
  ...
  r31.set("phase", 2);
  r31.set("phaseTitle", "3D Graphics & Math");
  ...
  r32.set("phase", 3);
  r32.set("phaseTitle", "Game Engine (Unity or Unreal)");
  ...
  r33.set("phase", 4);
  r33.set("phaseTitle", "XR Development");
  ...
  r34.set("phase", 5);
  r34.set("phaseTitle", "Performance & Deployment");
  ...
  r35.set("phase", 1);
  r35.set("phaseTitle", "Programming & Math");
  ...
  r36.set("phase", 2);
  r36.set("phaseTitle", "ROS (Robot Operating System)");
  ...
  r37.set("phase", 3);
  r37.set("phaseTitle", "Sensors & Perception");
  ...
  r38.set("phase", 4);
  r38.set("phaseTitle", "Motion Planning & Control");
  ...
  r39.set("phase", 5);
  r39.set("phaseTitle", "Simulation & Deployment");
  ...
  r40.set("phase", 1);
  r40.set("phaseTitle", "Networking Fundamentals");
  ...
  r41.set("phase", 2);
  r41.set("phaseTitle", "Routing & Switching");
  ...
  r42.set("phase", 3);
  r42.set("phaseTitle", "Network Security");
  ...
  r43.set("phase", 4);
  r43.set("phaseTitle", "Cloud Networking");
  ...
  r44.set("phase", 5);
  r44.set("phaseTitle", "Automation & SDN");
