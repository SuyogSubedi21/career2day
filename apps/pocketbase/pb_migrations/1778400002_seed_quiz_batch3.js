...
migrate((app) => {
  ...
  r0.set("explanation", "Answer: Quantum bit that can be 0, 1, or both simultaneously");
  ...
  r1.set("explanation", "Answer: Qubit existing in multiple states simultaneously");
  ...
  r2.set("explanation", "Answer: Qubits being correlated regardless of distance");
  ...
  r3.set("explanation", "Answer: Grover's Algorithm");
  ...
  r4.set("explanation", "Answer: IBM's open-source quantum computing SDK");
  ...
  r5.set("explanation", "Answer: Creates superposition from basis states");
  ...
  r6.set("explanation", "Answer: Loss of quantum properties due to environment interaction");
  ...
  r7.set("explanation", "Answer: Noisy Intermediate-Scale Quantum - current era of imperfect quantum computers");
  ...
  r8.set("explanation", "Answer: It is impossible to create an identical copy of an unknown quantum state");
  ...
  r9.set("explanation", "Answer: Factoring large integers exponentially faster than classical computers");
  ...
  r10.set("explanation", "Answer: Encoding logical qubits into multiple physical qubits to detect and correct errors from decoherence");
  ...
  r11.set("explanation", "Answer: Hybrid quantum-classical algorithm using parameterized circuit to find ground state energy");
  ...
  r12.set("explanation", "Answer: Problems solvable by quantum computers in polynomial time with bounded error");
  ...
  r13.set("explanation", "Answer: Transferring quantum state (not matter) from one qubit to another using entanglement and classical communication");
  ...
  r14.set("explanation", "Answer: Leading quantum error correction code using 2D lattice of physical qubits");
  ...
  r15.set("explanation", "Answer: AR overlays digital on real world; VR creates fully virtual environment");
  ...
  r16.set("explanation", "Answer: Unity");
  ...
  r17.set("explanation", "Answer: Representing 3D rotations without gimbal lock");
  ...
  r18.set("explanation", "Answer: Six degrees of freedom - full movement tracking in 3D space");
  ...
  r19.set("explanation", "Answer: Mismatch between visual motion and vestibular system");
  ...
  r20.set("explanation", "Answer: Rendering at full quality only where user is looking to save GPU");
  ...
  r21.set("explanation", "Answer: Technique to reduce perceived latency by warping last rendered frame while new frame renders");
  ...
  r22.set("explanation", "Answer: CPU instruction to GPU to render an object");
  ...
  r23.set("explanation", "Answer: Tracking using cameras mounted on the headset");
  ...
  r24.set("explanation", "Answer: 3D positional sound that changes based on listener position and environment");
  ...
  r25.set("explanation", "Answer: URP is mobile/XR with lower GPU cost; HDRP is for high-end visuals on PC/console");
  ...
  r26.set("explanation", "Answer: Simultaneous Localization and Mapping - tracking device position while building environment map");
  ...
  r27.set("explanation", "Answer: Computing joint positions from end-effector position to drive realistic body movement");
  ...
  r28.set("explanation", "Answer: Near-human avatars that are almost but not quite realistic enough, causing discomfort");
  ...
  r29.set("explanation", "Answer: Creating 3D models from photographs of real-world objects");
  ...
  r30.set("explanation", "Answer: Robot Operating System - middleware for robot software");
  ...
  r31.set("explanation", "Answer: Simultaneous Localization and Mapping");
  ...
  r32.set("explanation", "Answer: Proportional-Integral-Derivative control algorithm");
  ...
  r33.set("explanation", "Answer: Computing end-effector position from joint angles");
  ...
  r34.set("explanation", "Answer: Laser sensor that measures distances to create 3D maps");
  ...
  r35.set("explanation", "Answer: Optimal state estimation by combining predictions and noisy sensor measurements");
  ...
  r36.set("explanation", "Answer: Computing joint angles needed to reach a desired end-effector position");
  ...
  r37.set("explanation", "Answer: Hierarchical structure for organizing robot decision-making behaviors");
  ...
  r38.set("explanation", "Answer: Combining data from multiple sensors to improve accuracy");
  ...
  r39.set("explanation", "Answer: Applying policies trained in simulation to real robots");
  ...
  r40.set("explanation", "Answer: Controlling the robot's mechanical impedance (force-position relationship) for safe interaction");
  ...
  r41.set("explanation", "Answer: Optimization-based control using a model to predict future states and minimize cost over horizon");
  ...
  r42.set("explanation", "Answer: Randomizing simulation parameters so policy transfers to real world despite differences");
  ...
  r43.set("explanation", "Answer: Matrix relating joint velocities to end-effector velocities");
  ...
  r44.set("explanation", "Answer: Real-time industrial Ethernet protocol for deterministic communication with actuators");
  ...
  r46.set("explanation", "Answer: Virtual LAN - logical network segmentation on physical network");
  ...
  r47.set("explanation", "Answer: Transmission Control Protocol");
  ...
  r48.set("explanation", "Answer: Open Shortest Path First - link-state routing protocol");
  ...
  r49.set("explanation", "Answer: Defines which portion of IP address is network vs host");
  ...
  r50.set("explanation", "Answer: Routing between autonomous systems on the internet");
  ...
  r51.set("explanation", "Answer: Prevents network loops in Ethernet networks by blocking redundant paths");
  ...
  r52.set("explanation", "Answer: Quality of Service - prioritizing network traffic types");
  ...
  r53.set("explanation", "Answer: Multi-Protocol Label Switching - fast packet forwarding using labels");
  ...
  r54.set("explanation", "Answer: Hub broadcasts to all ports; switch forwards to specific MAC address");
  ...
  r55.set("explanation", "Answer: Equal-Cost Multi-Path - load balancing across multiple equal-cost routes");
  ...
  r56.set("explanation", "Answer: Virtual Extensible LAN - encapsulates L2 frames in UDP for overlay networks");
  ...
  r57.set("explanation", "Answer: Bidirectional Forwarding Detection - fast failure detection between neighbors");
  ...
  r58.set("explanation", "Answer: HSRP is Cisco proprietary; VRRP is open standard; both provide gateway redundancy");
  ...
  r59.set("explanation", "Answer: Data modeling language for network configuration used with NETCONF/RESTCONF");
  ...
  r60.set("explanation", "Answer: Designs technical solutions aligned with business requirements");
  ...
  r61.set("explanation", "Answer: Best practices for cloud architecture across reliability, security, performance, cost, operations");
  ...
  r62.set("explanation", "Answer: Ability to handle growing workloads by adding resources");
  ...
  r63.set("explanation", "Answer: Total Cost of Ownership");
  ...
  r64.set("explanation", "Answer: Application composed of small independent deployable services");
  ...
  r65.set("explanation", "Answer: Gradually replacing a legacy system by wrapping it with new services");
  ...
  r66.set("explanation", "Answer: Architecture Decision Record - documents a significant design choice with context");
  ...
  r67.set("explanation", "Answer: Components communicate through producing and consuming events asynchronously");
  ...
  r68.set("explanation", "Answer: Context, Containers, Components, Code - levels of abstraction for architecture diagrams");
  ...
  r69.set("explanation", "Answer: Set of principles for building scalable, maintainable cloud-native apps");
  ...
  r70.set("explanation", "Answer: Explicit boundary within which a domain model applies and is consistent");
  ...
  r71.set("explanation", "Answer: CapEx is upfront capital investment; OpEx is ongoing operational expense. Cloud shifts CapEx to OpEx.");
  ...
  r72.set("explanation", "Answer: Cloud provider secures infrastructure; customer secures data, applications, and configuration");
  ...
  r73.set("explanation", "Answer: Serving live traffic from multiple regions simultaneously for resilience and low latency");
  ...
  r74.set("explanation", "Answer: Sync waits for response before proceeding; async sends request and continues, response handled later");
  ...
  r75.set("explanation", "Answer: Atomicity, Consistency, Isolation, Durability");
  ...
  r76.set("explanation", "Answer: Data structure that speeds up queries");
  ...
  r77.set("explanation", "Answer: Organizing database to reduce redundancy");
  ...
  r78.set("explanation", "Answer: Column that references primary key of another table");
  ...
  r79.set("explanation", "Answer: Virtual table based on a SELECT query");
  ...
  r80.set("explanation", "Answer: Multi-Version Concurrency Control - allows concurrent reads without locking by keeping row versions");
  ...
  r81.set("explanation", "Answer: Index that contains all columns needed by a query, avoiding table lookup");
  ...
  r82.set("explanation", "Answer: Read Committed");
  ...
  r83.set("explanation", "Answer: Pre-computed view stored physically that is refreshed periodically");
  ...
  r84.set("explanation", "Answer: Write-Ahead Log - changes logged before applied to ensure durability and recovery");
  ...
  r85.set("explanation", "Answer: Physical replicates byte-level changes to the whole cluster; logical replicates table-level changes selectively");
  ...
  r86.set("explanation", "Answer: Automatically reclaims dead tuple space from MVCC to prevent table bloat and maintain statistics");
  ...
  r87.set("explanation", "Answer: Hash join builds hash table for one relation; nested loop iterates over every row pair. Hash is better for large tables.");
  ...
  r88.set("explanation", "Answer: High-availability solution for PostgreSQL using etcd/Consul for leader election and failover");
  ...
  r89.set("explanation", "Answer: Can only guarantee 2 of Consistency/Availability/Partition-tolerance; guides choice between SQL (CP) and NoSQL (AP)");
  ...
  r90.set("explanation", "Answer: Core cycle that processes input, updates game state, and renders every frame");
  ...
  r91.set("explanation", "Answer: Time elapsed since last frame used for frame-rate independent movement");
  ...
  r92.set("explanation", "Answer: Reusing objects instead of creating/destroying them to save performance");
  ...
  r93.set("explanation", "Answer: Reusable template of a GameObject with all components");
  ...
  r94.set("explanation", "Answer: Data structure representing walkable surfaces for AI pathfinding");
  ...
  r95.set("explanation", "Answer: Data-oriented design pattern separating data (components) from logic (systems) for performance");
  ...
  r96.set("explanation", "Answer: Rewinding and resimulating game state when server correction arrives for smooth multiplayer");
  ...
  r97.set("explanation", "Answer: Data container asset that persists outside scenes for shared game data");
  ...
  r98.set("explanation", "Answer: Algorithmically generating content like levels or worlds at runtime");
  ...
  r99.set("explanation", "Answer: Client simulates actions immediately without waiting for server confirmation");
  ...
  r100.set("explanation", "Answer: Multithreaded code execution system that safely runs jobs in parallel without race conditions");
  ...
  r101.set("explanation", "Answer: Server rewinds world state to when client fired to validate hits fairly");
  ...
  r102.set("explanation", "Answer: GPU-bound: rendering is bottleneck; CPU-bound: logic/physics is bottleneck");
  ...
  r103.set("explanation", "Answer: LLVM-based compiler that compiles C# Job System code to highly optimized native code");
  ...
  r104.set("explanation", "Answer: CPU instruction to GPU to render; minimizing reduces CPU-GPU communication overhead");
